...
public record ScheduleModifyRequest(@Length(min = 1, max = 30) String title, @Length(max = 500) String description,
		boolean isAllDay, @NotNull LocalDateTime startDateTime, @NotNull LocalDateTime endDateTime, boolean isRepeated,
		@Validated RepetitionUpdateRequest repetition, @NotNull String place, @NotNull boolean setLocation,
		@ValidLatitude Double latitude, @ValidLongitude Double longitude, boolean setAlarm, Long categoryId,
		List<LocalDateTime> alarmTimes, Long calendarId) {
