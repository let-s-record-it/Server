...
public class RepetitionPattern extends BaseTime {
    ...
    public static RepetitionPattern create(
        ...
        return switch (repetitionType) {
            case DAILY -> createDaily(
                    repetitionPeriod, repetitionStartDate, repetitionEndDate, scheduleGroup);
            case WEEKLY -> createWeekly(
                    repetitionPeriod,
                    repetitionStartDate,
                    repetitionEndDate,
                    weekdayBit,
                    scheduleGroup);
            case MONTHLY_WITH_DATE -> createMonthlyWithDate(
                    repetitionPeriod,
                    repetitionStartDate,
                    repetitionEndDate,
                    dayOfMonth,
                    scheduleGroup);
            case MONTHLY_WITH_WEEKDAY -> createMonthlyWithWeekday(
                    repetitionPeriod,
                    repetitionStartDate,
                    repetitionEndDate,
                    weekNumber,
                    weekday,
                    scheduleGroup);
            case MONTHLY_WITH_LAST_DAY -> createMonthlyWithLastDay(
                    repetitionPeriod, repetitionStartDate, repetitionEndDate, scheduleGroup);
            case YEARLY_WITH_DATE -> createYearlyWithDate(
                    repetitionPeriod,
                    repetitionStartDate,
                    repetitionEndDate,
                    monthOfYear,
                    dayOfMonth,
                    scheduleGroup);
            case YEARLY_WITH_WEEKDAY -> createYearlyWithWeekday(
                    repetitionPeriod,
                    repetitionStartDate,
                    repetitionEndDate,
                    monthOfYear,
                    ...
                    weekday,
                    scheduleGroup);
            case YEARLY_WITH_LAST_DAY -> createYearlyWithLastDay(
                    repetitionPeriod,
                    repetitionStartDate,
                    repetitionEndDate,
                    monthOfYear,
