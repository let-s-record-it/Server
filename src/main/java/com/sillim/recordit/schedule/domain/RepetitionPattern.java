...
public class RepetitionPattern extends BaseTime {
    ...
    public static RepetitionPattern createMonthlyWithDate(Integer repetitionPeriod,
            LocalDateTime repetitionStartDate,
            LocalDateTime repetitionEndDate,
            Integer dayOfMonth,
            ScheduleGroup scheduleGroup) {
    ...
    public static RepetitionPattern createYearlyWithDate(Integer repetitionPeriod,
            LocalDateTime repetitionStartDate,
            LocalDateTime repetitionEndDate,
            Integer monthOfYear,
            Integer dayOfMonth,
    ...
    public static RepetitionPattern createYearlyWithWeekday(Integer repetitionPeriod,
            LocalDateTime repetitionStartDate,
            LocalDateTime repetitionEndDate,
            Integer monthOfYear,
            WeekNumber weekNumber,
    ...
    public static RepetitionPattern createYearlyWithLastDay(Integer repetitionPeriod,
            LocalDateTime repetitionStartDate,
            LocalDateTime repetitionEndDate,
            Integer monthOfYear,
            ScheduleGroup scheduleGroup) {
    ...
    public static RepetitionPattern create(
        ...
        if (repetitionType.equals(RepetitionType.DAILY)) {
            return createDaily(repetitionPeriod, repetitionStartDate, repetitionEndDate,
                    scheduleGroup);
        }
        if (repetitionType.equals(RepetitionType.WEEKLY)) {
            return createWeekly(repetitionPeriod, repetitionStartDate, repetitionEndDate,
                    weekdayBit, scheduleGroup);
        }
        if (repetitionType.equals(RepetitionType.MONTHLY_WITH_DATE)) {
            return createMonthlyWithDate(repetitionPeriod, repetitionStartDate, repetitionEndDate,
                    dayOfMonth, scheduleGroup);
        }
        if (repetitionType.equals(RepetitionType.MONTHLY_WITH_WEEKDAY)) {
            return createMonthlyWithWeekday(repetitionPeriod, repetitionStartDate,
                    repetitionEndDate, weekNumber, weekday, scheduleGroup);
        }
        if (repetitionType.equals(RepetitionType.MONTHLY_WITH_LAST_DAY)) {
            return createMonthlyWithLastDay(repetitionPeriod, repetitionStartDate,
                    repetitionEndDate, scheduleGroup);
        }
        if (repetitionType.equals(RepetitionType.YEARLY_WITH_DATE)) {
            return createYearlyWithDate(repetitionPeriod, repetitionStartDate, repetitionEndDate,
                    monthOfYear, dayOfMonth, scheduleGroup);
        }
        if (repetitionType.equals(RepetitionType.YEARLY_WITH_WEEKDAY)) {
            return createYearlyWithWeekday(repetitionPeriod, repetitionStartDate, repetitionEndDate,
                    monthOfYear, weekNumber, weekday, scheduleGroup);
        }
        if (repetitionType.equals(RepetitionType.YEARLY_WITH_LAST_DAY)) {
            return createYearlyWithLastDay(repetitionPeriod, repetitionStartDate, repetitionEndDate,
                    monthOfYear, scheduleGroup);
        }
    ...
    private Stream<TemporalAmount> monthlyWithWeekdayRepeatingStream() {
        return Stream.iterate(repetitionStartDate,
                        date -> date.isBefore(
                                repetitionEndDate.with(TemporalAdjusters.lastDayOfMonth()).plusDays(1L)),
                        date -> date.plusMonths(repetitionPeriod))
    ...
    private static void validateMonthOfYearEqualsStartDateMonth(LocalDateTime startDate,
            Integer monthOfYear) {
