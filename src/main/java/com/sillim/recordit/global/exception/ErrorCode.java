...
public enum ErrorCode {
	...
	NULL_SCHEDULE_COLOR_HEX("ERR_SCHEDULE_006", "색상 값은 null일 수 없습니다."),
	INVALID_SCHEDULE_COLOR_HEX("ERR_SCHEDULE_007", "유효하지 않은 색상 값입니다."),
	...
	INVALID_DURATION("ERR_SCHEDULE_010", "시작 시간은 종료 시간보다 클 수 없습니다."),
	INVALID_REPETITION_PERIOD("ERR_SCHEDULE_011", "반복 주기는 1 이상 999 이하여야 합니다."),
