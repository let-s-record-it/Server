...
public interface MemberRepository extends Neo4jRepository<Member, Long> {
	...
	@Query("""
			...
			""")
	boolean existsByFollower(@Param("me") String myPersonalId, @Param("other") String otherPersonalId);
	...
	@Query("""
			...
			DELETE r
			""")
	void deleteFollowRelation(@Param("follower") Long followerId, @Param("followed") Long followedId);
