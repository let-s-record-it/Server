...
class FeedTitleTest {
	...
	void throwInvalidTitleExceptionIfTitleIsNull() {
		assertThatCode(() -> new FeedTitle(null)).isInstanceOf(InvalidTitleException.class)
	...
	void throwInvalidTitleExceptionIfTitleIsBlank() {
		assertThatCode(() -> new FeedTitle("    ")).isInstanceOf(InvalidTitleException.class)
	...
	void throwInvalidTitleExceptionIfTitleLengthIs30Over() {
		assertThatCode(() -> new FeedTitle("1234567890123456789012345678901")).isInstanceOf(InvalidTitleException.class)
