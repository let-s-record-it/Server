...
class TaskColorHexTest {
	...
	void throwInvalidColorHexExceptionIfNull() {
		assertThatCode(() -> new TaskColorHex(null)).isInstanceOf(InvalidColorHexException.class)
	...
	void throwInvalidColorHexExceptionIfNotFitColorHex() {
		assertAll(() -> {
			assertThatCode(() -> new TaskColorHex("11233")).isInstanceOf(InvalidColorHexException.class)
					.hasMessage(ErrorCode.INVALID_TASK_COLOR_HEX.getDescription());
			assertThatCode(() -> new TaskColorHex("ggg")).isInstanceOf(InvalidColorHexException.class)
					.hasMessage(ErrorCode.INVALID_TASK_COLOR_HEX.getDescription());
			assertThatCode(() -> new TaskColorHex("11233")).isInstanceOf(InvalidColorHexException.class)
					.hasMessage(ErrorCode.INVALID_TASK_COLOR_HEX.getDescription());
			assertThatCode(() -> new TaskColorHex("ffda12f")).isInstanceOf(InvalidColorHexException.class)
					.hasMessage(ErrorCode.INVALID_TASK_COLOR_HEX.getDescription());
			assertThatCode(() -> new TaskColorHex("fb")).isInstanceOf(InvalidColorHexException.class)
					.hasMessage(ErrorCode.INVALID_TASK_COLOR_HEX.getDescription());
		});
	}
}
