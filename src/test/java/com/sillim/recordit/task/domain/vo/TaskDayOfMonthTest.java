...
class TaskDayOfMonthTest {
	...
	void validIfDateIsInMonthForYearlyRepeating() {
		assertAll(
				() -> {
					assertThatCode(() -> TaskDayOfMonth.createYearly(2, 29))
							.doesNotThrowAnyException();
					assertThatCode(() -> TaskDayOfMonth.createYearly(12, 31))
							.doesNotThrowAnyException();
				});
	}
	...
	void throwInvalidDayOfMonthExceptionIfDayOfMonthIsNull() {
		assertThatCode(() -> TaskDayOfMonth.createMonthly(null))
	...
	void throwInvalidDayOfMonthExceptionIfDayOfMonthOrMonthOfYearIsNull() {
		assertAll(
				() -> {
					assertThatCode(() -> TaskDayOfMonth.createYearly(null, 29))
							.isInstanceOf(InvalidDayOfMonthException.class)
							.hasMessage(ErrorCode.NULL_TASK_MONTH_OF_YEAR.getDescription());
					assertThatCode(() -> TaskDayOfMonth.createYearly(2, null))
							.isInstanceOf(InvalidDayOfMonthException.class)
							.hasMessage(ErrorCode.NULL_TASK_DAY_OF_MONTH.getDescription());
				});
	}
	...
	void throwInvalidDayOfMonthExceptionIfDayOfMonthIsOutOfRangeForMonthlyRepeating() {
		assertAll(
				() -> {
					// 반복 일자가 1 미만
					assertThatCode(() -> TaskDayOfMonth.createMonthly(0))
							.isInstanceOf(InvalidDayOfMonthException.class)
							.hasMessage(ErrorCode.TASK_DAY_OF_MONTH_OUT_OF_RANGE.getDescription());
					// 반복 일자가 31 초과
					assertThatCode(() -> TaskDayOfMonth.createMonthly(32))
							.isInstanceOf(InvalidDayOfMonthException.class)
							.hasMessage(ErrorCode.TASK_DAY_OF_MONTH_OUT_OF_RANGE.getDescription());
				});
	}
	...
	void throwInvalidDayOfMonthExceptionIfDayOfMonthIsNotInMonthForYearlyRepeating() {
		assertAll(
				() -> {
					assertThatCode(() -> TaskDayOfMonth.createYearly(1, 0))
							.isInstanceOf(InvalidDayOfMonthException.class)
							.hasMessage(ErrorCode.TASK_DAY_OF_MONTH_OUT_OF_RANGE.getDescription());
					assertThatCode(() -> TaskDayOfMonth.createYearly(2, 31))
							.isInstanceOf(InvalidDayOfMonthException.class)
							.hasMessage(ErrorCode.TASK_DAY_OF_MONTH_OUT_OF_RANGE.getDescription());
					assertThatCode(() -> TaskDayOfMonth.createYearly(4, 31))
							.isInstanceOf(InvalidDayOfMonthException.class)
							.hasMessage(ErrorCode.TASK_DAY_OF_MONTH_OUT_OF_RANGE.getDescription());
					assertThatCode(() -> TaskDayOfMonth.createYearly(5, 32))
							.isInstanceOf(InvalidDayOfMonthException.class)
							.hasMessage(ErrorCode.TASK_DAY_OF_MONTH_OUT_OF_RANGE.getDescription());
				});
	}
