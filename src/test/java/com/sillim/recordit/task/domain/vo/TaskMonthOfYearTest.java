...
class TaskMonthOfYearTest {
	...
	void throwInvalidMonthOfYearExceptionIfMonthOfYearIsNull() {
		assertThatCode(() -> new TaskMonthOfYear(null)).isInstanceOf(InvalidMonthOfYearException.class)
	...
	void throwInvalidMonthOfYearExceptionIf1Under() {
		assertThatCode(() -> new TaskMonthOfYear(0)).isInstanceOf(InvalidMonthOfYearException.class)
	...
	void throwInvalidMonthOfYearExceptionIf12Over() {
		assertThatCode(() -> new TaskMonthOfYear(13)).isInstanceOf(InvalidMonthOfYearException.class)
				.hasMessage(ErrorCode.TASK_MONTH_OF_YEAR_OUT_OF_RANGE.getDescription());
	}
}
