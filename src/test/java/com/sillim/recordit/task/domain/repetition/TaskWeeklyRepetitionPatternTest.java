...
class TaskWeeklyRepetitionPatternTest {
	...
	void createWeeklyRepeatingPatternWithPeriod1() {
		TaskRepetitionPattern repetitionPattern = TaskWeeklyRepetitionPattern.createWeekly(1, LocalDate.of(2024, 1, 1),
				LocalDate.of(2024, 1, 31), Integer.parseInt("1110100", 2), taskGroup);
	...
	void createWeeklyRepeatingPatternScheduleStreamWithPeriod2() {
		// 1월 1일 ~ 1월 31일까지, 수/금/토/일 반복
		TaskRepetitionPattern repetitionPattern = TaskWeeklyRepetitionPattern.createWeekly(2, LocalDate.of(2024, 1, 1),
				LocalDate.of(2024, 1, 31), Integer.parseInt("1110100", 2), taskGroup);
