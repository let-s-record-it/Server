...
class RepetitionPatternServiceTest {
    ...
    void addRepetitionPattern() {
        ...
        RepetitionPattern expectedRepetitionPattern = RepetitionPattern.createDaily(1,
                repetitionStartDate, repetitionEndDate, scheduleGroup);
        ...
        given(repetitionPatternRepository.save(any(RepetitionPattern.class))).willReturn(
                expectedRepetitionPattern);

        RepetitionPattern repetitionPattern = repetitionPatternService.addRepetitionPattern(
                repetitionAddRequest, scheduleGroup);
