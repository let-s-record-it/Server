...
class LocationTest {
    ...
    void validIfLatitude0OrOver90OrUnderAndLongitude0OrOverAnd180OrUnder() {
        ...
        assertAll(() -> {
            ...
            assertThat(location1.getLatitude()).isEqualByComparingTo(BigDecimal.valueOf(0L));
            assertThat(location1.getLongitude()).isEqualByComparingTo(BigDecimal.valueOf(0L));
            assertThat(location2.getLatitude()).isEqualByComparingTo(BigDecimal.valueOf(90L));
            assertThat(location2.getLongitude()).isEqualByComparingTo(BigDecimal.valueOf(180L));
        });
    }
