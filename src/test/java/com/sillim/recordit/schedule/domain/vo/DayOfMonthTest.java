...
class DayOfMonthTest {
    ...
    void validIfDateIsInMonthForYearlyRepeating() {
        assertAll(() -> {
            assertThatCode(() -> DayOfMonth.createYearly(2, 29))
                    .doesNotThrowAnyException();
            assertThatCode(() -> DayOfMonth.createYearly(12, 31))
                    .doesNotThrowAnyException();
        });
    }
    ...
    void throwInvalidDayOfMonthExceptionIfDayOfMonthIs1UnderForMonthlyRepeating() {
        assertThatCode(() -> DayOfMonth.createMonthly(0))
    ...
    void throwInvalidDayOfMonthExceptionIfDayOfMonthIs12OverForMonthlyRepeating() {
        assertThatCode(() -> DayOfMonth.createMonthly(32))
                .isInstanceOf(InvalidDayOfMonthException.class)
                .hasMessage(ErrorCode.INVALID_DAY_OF_MONTH.getDescription());
    }
    ...
    void throwInvalidDayOfMonthExceptionIfDayOfMonthIsNotInMonthForYearlyRepeating() {
        assertAll(() -> {
            assertThatCode(() -> DayOfMonth.createYearly(1, 0))
                    .isInstanceOf(InvalidDayOfMonthException.class)
                    .hasMessage(ErrorCode.INVALID_DAY_OF_MONTH.getDescription());
            assertThatCode(() -> DayOfMonth.createYearly(2, 31))
                    .isInstanceOf(InvalidDayOfMonthException.class)
                    .hasMessage(ErrorCode.INVALID_DAY_OF_MONTH.getDescription());
            assertThatCode(() -> DayOfMonth.createYearly(4, 31))
                    .isInstanceOf(InvalidDayOfMonthException.class)
                    .hasMessage(ErrorCode.INVALID_DAY_OF_MONTH.getDescription());
