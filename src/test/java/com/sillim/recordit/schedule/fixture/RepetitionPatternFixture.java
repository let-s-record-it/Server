...
public enum RepetitionPatternFixture {
    ...
    START_IS_AFTER_END(RepetitionType.DAILY,
            1,
            ...
            null,
            null),
    PERIOD_1_UNDER(RepetitionType.DAILY,
            0,
            ...
            null,
            null),
    PERIOD_999_OVER(RepetitionType.DAILY,
            1000,
            LocalDateTime.of(2024, 1, 1, 0, 0),
            LocalDateTime.of(2024, 3, 31, 0, 0),
            null,
    ...
    MONTHLY_WITH_DATE(RepetitionType.MONTHLY_WITH_DATE,
            1,
            ...
            null,
            null),
    MONTHLY_WITH_WEEKDAY(RepetitionType.MONTHLY_WITH_WEEKDAY,
            1,
            LocalDateTime.of(2024, 1, 12, 0, 0),
            LocalDateTime.of(2024, 3, 31, 0, 0),
            null,
            ...
            Weekday.FRI,
            null),
    MONTHLY_WITH_LAST_DAY(RepetitionType.MONTHLY_WITH_LAST_DAY,
            1,
            LocalDateTime.of(2024, 1, 31, 0, 0),
            LocalDateTime.of(2024, 3, 31, 0, 0),
            null,
            ...
            null,
            null),
    YEARLY_WITH_DATE(RepetitionType.YEARLY_WITH_DATE,
            1,
            ...
            null,
            null),
    YEARLY_WITH_WEEKDAY(RepetitionType.YEARLY_WITH_WEEKDAY,
            1,
            LocalDateTime.of(2024, 2, 12, 0, 0),
            LocalDateTime.of(2025, 3, 31, 0, 0),
            2,
            ...
            Weekday.MON,
            null),
    YEARLY_WITH_LAST_DAY(RepetitionType.YEARLY_WITH_LAST_DAY,
            1,
            ...
            null,
            null),
    NOT_EQUAL_DAY_OF_MONTH(RepetitionType.YEARLY_WITH_DATE,
            1,
            LocalDateTime.of(2024, 2, 12, 0, 0),
            LocalDateTime.of(2025, 3, 31, 0, 0),
            2,
            ...
            null,
            null),
    NOT_EQUAL_MONTH_OF_YEAR(RepetitionType.YEARLY_WITH_LAST_DAY,
            1,
            LocalDateTime.of(2024, 2, 29, 0, 0),
            LocalDateTime.of(2025, 3, 31, 0, 0),
            3,
    ...
    RepetitionPatternFixture(RepetitionType repetitionType,
    ...
    public RepetitionPattern getRepetitionPattern(ScheduleGroup scheduleGroup) {
        return RepetitionPattern.create(repetitionType, repetitionPeriod, repetitionStartDate,
                repetitionEndDate, monthOfYear, dayOfMonth, weekNumber, weekday, weekdayBit,
                scheduleGroup);
    }
